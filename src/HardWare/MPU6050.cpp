...
namespace HardWare{
    ...
    bool MPU6050::Set_Gyro_Fsr(Gyro_Fsr Fsr){
        return false;
    }
    //设置MPU6050加速度传感器满量程范围
    bool MPU6050::Set_Accel_Fsr(Accel_Fsr Fsr){
        return false;
    }
    //设置MPU6050的数字低通滤波器
    bool MPU6050::Set_LPF(u_short Lpf){
        u_char data=0;
        if(Lpf>=188)data=1;
    ...
    bool MPU6050::Set_Rate(u_short Rate){
        u_char data;
    ...
    bool MPU6050::Refresh_Gyroscope(){
        ...
        if(res==0){
            ...
            this->Gyroscope_Pack.gz=((u_short)buf[4]<<8)|buf[5];
        } 	
        return res;
    }
    ...
    bool MPU6050::Refresh_Accelerometer(){
        ...
        if(res==0){
            ...
            this->Accelerometer_Pack.az=((u_short)buf[4]<<8)|buf[5];
        } 	
        return res;
    }
}